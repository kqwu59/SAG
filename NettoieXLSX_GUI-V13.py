...
class App(BaseTk):
    def __init__(self):
        ...
        self._log("Attention, mettez les bons fichiers sur la bonne ligne")
        self._log("Astuce : glissez vos fichiers .xlsx sur les champs .")
        self._log("Seules les lignes sous 'Liste des résultats' seront prises en compte.")
